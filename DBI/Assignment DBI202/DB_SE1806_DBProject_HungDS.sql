CREATE database DB_SE1806_DBProject_KhoaDĐ_TuNT_HungDS

use DB_SE1806_DBProject_KhoaDĐ_TuNT_HungDS
...
CREATE TABLE BaiViet (
    ...
    FOREIGN KEY (MaCM) REFERENCES DanhMuc(MaCM),
...
CREATE TABLE BinhLuan (
    ...
    MaTT INT,
    UserID INT,
    TenNguoiBL NVARCHAR(250),
    EmailNguoiBL NVARCHAR(250),
    NoiDungBL TEXT,
    NgayBL DATE,
...
CREATE TABLE QuangCao (
    ...
    TieuDeQC NVARCHAR(250),
    NoiDungQC TEXT,
    HinhAnhQC NVARCHAR(250),
    ThoiGianBatDau DATE,
...
CREATE TABLE LienHe (
    ...
    EmailLH NVARCHAR(250),
    SoDienThoaiLH DECIMAL(18,0),
    NoiDungLH TEXT,
    NgayLH DATE
);
...
CREATE TABLE RaoVat (
    ...
    TieuDeRV NVARCHAR(250),
    NoiDungRV TEXT,
    ThoiGianDangRV DATE,
    LienHeRV NVARCHAR(250),
    MaKV INT,
    FOREIGN KEY (MaKV) REFERENCES KhuVuc(MaKV)
);
...
CREATE TABLE Startup (
    ...
    TenStartup NVARCHAR(250),
    MoTaStartup TEXT,
    NgayThanhLap DATE,
    LienHeStartup NVARCHAR(250),
    MaKV INT,
    FOREIGN KEY (MaKV) REFERENCES KhuVuc(MaKV)
);
...
INSERT INTO KhuVuc (MaKV, TenKV, MoTaKV) VALUES
(1, N'Khu vực phía Bắc', N'Bao gồm các tỉnh và thành phố phía Bắc Việt Nam'),
(2, N'Khu vực phía Nam', N'Bao gồm các tỉnh và thành phố phía Nam Việt Nam');
...
(3, N'Quảng cáo 3', N'Nội dung quảng cáo 3', N'quangcao3.jpg', '2024-03-01', '2024-08-30', 3),
(4, N'Quảng cáo 4', N'Nội dung quảng cáo 4', N'quangcao4.jpg', '2024-04-01', '2024-09-30', 4),
(5, N'Quảng cáo 5', N'Nội dung quảng cáo 5', N'quangcao5.jpg', '2024-05-01', '2024-10-30', 5),
(6, N'Quảng cáo 6', N'Nội dung quảng cáo 6', N'quangcao6.jpg', '2024-06-01', '2024-11-30', 6),
(7, N'Quảng cáo 7', N'Nội dung quảng cáo 7', N'quangcao7.jpg', '2024-07-01', '2024-12-30', 7),
(8, N'Quảng cáo 8', N'Nội dung quảng cáo 8', N'quangcao8.jpg', '2024-08-01', '2025-01-30', 8),
(9, N'Quảng cáo 9', N'Nội dung quảng cáo 9', N'quangcao9.jpg', '2024-09-01', '2025-02-30', 9),
(10, N'Quảng cáo 10', N'Nội dung quảng cáo 10', N'quangcao10.jpg', '2024-10-01', '2025-03-30', 10);
...
(3, N'Rao vặt 3', N'Nội dung rao vặt 3', '2024-04-03', N'Liên hệ rao vặt 3', 3),
(4, N'Rao vặt 4', N'Nội dung rao vặt 4', '2024-04-04', N'Liên hệ rao vặt 4', 4),
(5, N'Rao vặt 5', N'Nội dung rao vặt 5', '2024-04-05', N'Liên hệ rao vặt 5', 5),
(6, N'Rao vặt 6', N'Nội dung rao vặt 6', '2024-04-06', N'Liên hệ rao vặt 6', 6),
(7, N'Rao vặt 7', N'Nội dung rao vặt 7', '2024-04-07', N'Liên hệ rao vặt 7', 7),
(8, N'Rao vặt 8', N'Nội dung rao vặt 8', '2024-04-08', N'Liên hệ rao vặt 8', 8),
(9, N'Rao vặt 9', N'Nội dung rao vặt 9', '2024-04-09', N'Liên hệ rao vặt 9', 9),
(10, N'Rao vặt 10', N'Nội dung rao vặt 10', '2024-04-10', N'Liên hệ rao vặt 10', 10);
...
(3, N'Startup 3', N'Mô tả startup 3', '2022-07-01', N'Liên hệ startup 3', 3),
(4, N'Startup 4', N'Mô tả startup 4', '2022-08-01', N'Liên hệ startup 4', 4),
(5, N'Startup 5', N'Mô tả startup 5', '2022-09-01', N'Liên hệ startup 5', 5),
(6, N'Startup 6', N'Mô tả startup 6', '2022-10-01', N'Liên hệ startup 6', 6),
(7, N'Startup 7', N'Mô tả startup 7', '2022-11-01', N'Liên hệ startup 7', 7),
(8, N'Startup 8', N'Mô tả startup 8', '2022-12-01', N'Liên hệ startup 8', 8),
(9, N'Startup 9', N'Mô tả startup 9', '2023-01-01', N'Liên hệ startup 9', 9),
(10, N'Startup 10', N'Mô tả startup 10', '2023-02-01', N'Liên hệ startup 10', 10);